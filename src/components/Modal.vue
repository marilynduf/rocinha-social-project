...
<transition name="modal">
    ...
    <div class="modal-mask">
      ...
      <h1>L'idée<img class="logo-rocinha" src="../assets/img/rocinha-logo.svg" alt="Logo Rocinha"></h1>
      ...
      <div class="home-nav">
        ...
        <nav>
          <li @click="$emit('close')" class="home-nav__item"><router-link to="/idee/idee">L'idée</router-link></li>
